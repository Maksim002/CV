...
public class FragmentBurning extends Fragment implements Listener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewBurning);
        recyclerView.setAdapter(adapter = new AdapterAll(getBurning(),this));
        adapter.updeteList(getBurning());

        return view;
    }

    List<Model> getBurning(){
